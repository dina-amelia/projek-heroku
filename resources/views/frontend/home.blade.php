            ...
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border px-3 mr-1">D</span>Shopper</h1>
                </a>
            </div>
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0"
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            <a href="/shop" class="nav-link" data-toggle="dropdown-item"> Pakaian Anak</a>
                            <a href="/shop" class="nav-link" data-toggle="dropdown-item"> Pakaian Remaja</a>
                            <a href="/shop" class="nav-link" data-toggle="dropdown-item"> Pakaian Dewasa</a>
                        </div>
                    </div>
                </nav>
            </div>
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="assets/img/1.png" alt="Image">
        ...
        <div class="row px-xl-5">
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <h1 class="mb-4 font-weight-semi-bold">Blazer Collection</h1>
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Jaket Collection</h1>
                        <a href="/shop" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-1.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Blazer Wanita </h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 95.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp. 105.000</del></h6>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-2.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Blazer Fashion Anak</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 100.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp. 120.000</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detail" class="btn btn-sm text-dark p-0"><i
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-3.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Dress Fashion Remaja</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 85.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp. 95.000</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detail" class="btn btn-sm text-dark p-0"><i
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-5.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Jaket Pria Dewasa</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 130.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp. 150.000</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detail" class="btn btn-sm text-dark p-0"><i
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-6.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Dress Anak Perempuan Korean Style</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 65.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp. 80.000</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detail" class="btn btn-sm text-dark p-0"><i
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-7.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Kaos Costum</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 30.000</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="assets/img/cat-8.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Baju Tidur Piyama</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp. 50.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp. 60.000</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detail" class="btn btn-sm text-dark p-0"><i
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Kaos Anak</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp.60.000</h6>
                            <h6 class="text-muted ml-2"><del>Rp.60.000</del></h6>
                        </div>
